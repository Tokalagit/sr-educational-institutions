...
export const SCHOOL_NAME = "SR.EDUCATIONAL INSTITUTIONS";
export const SCHOOL_SUBTITLE = "Junior & Degree College – Tirupati";
export const MOTTO = "OUR JOURNEY TOWARDS SUCCESS";
...
export const NAV_LINKS = [
  ...
  { 
    ...
    subLinks: [
      ...
      { label: 'Juniour College', href: '#campus-Juniour' },
...
export interface CampusDetail {
  ...
  photos: string[];
  highlights: string[];
  gymPhotos?: string[]; // Optional property for campuses with a gym
}
// --- NEW SECTION: CAMPUS SPECIFIC DETAILS ---
export const CAMPUS_DETAILS = [
  // {
  ...
  },
  {
    ...
    location: 'Tirupati',
    description: 'Our primary residential campus specializing in Intermediate MPC/BiPC with rigorous Defence training.',
    photos: ['image/sr junior college.jpeg'],
    // Added gymPhotos specifically for the Boys Campus
